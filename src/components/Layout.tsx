...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-bg">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 h-16 bg-bg/80 backdrop-blur-xl border-b border-zinc-800/50 z-50">
        <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold hidden sm:block">aeroCheck</span>
          </Link>
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="lg:hidden absolute top-16 left-0 right-0 bg-bg border-b border-zinc-800 p-4">
